...
export default function Hero() {
  return (
    <section className="w-full bg-gradient-to-b from-gray-900 to-gray-700 py-16 px-4 md:px-12 text-white text-center flex flex-col items-center">
      {/* Título principal */}
      ...
      <p className="text-lg lg:text-xl max-w-3xl text-white/80 mt-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-white/90 max-w-6xl mt-10 w-full">
      ...
      {/* Separador visual */}
      <div className="w-2/3 h-[2px] bg-white/50 my-10"></div>
    </section>
  );
}
